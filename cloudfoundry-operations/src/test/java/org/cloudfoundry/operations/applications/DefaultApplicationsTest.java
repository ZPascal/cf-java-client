...
final class DefaultApplicationsTest extends AbstractOperationsTest {
    ...
    void copySourceNoRestartOrgSpace() {
        ...
        requestOrganizationSpacesByName(
                this.cloudFoundryClient,
                "test-organization-resource-metadata-id",
                "test-target-space");
        requestApplications(
                this.cloudFoundryClient,
                "test-target-application-name",
                "test-space-resource-metadata-id",
                "test-metadata-id");
    ...
    void copySourceNoRestartSpace() {
        ...
        requestSpace(this.cloudFoundryClient, TEST_SPACE_ID, TEST_ORGANIZATION_ID);
        requestOrganizationSpacesByName(
                this.cloudFoundryClient, TEST_ORGANIZATION_ID, "test-target-space");
        requestApplications(
                this.cloudFoundryClient,
                "test-target-application-name",
                "test-space-resource-metadata-id",
    ...
    @Test
    void copySourceOrganizationNotFound() {
        requestApplications(
                this.cloudFoundryClient,
                "test-application-name",
                TEST_SPACE_ID,
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage(
                                                "Organization test-target-organization not found"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void copySourceRestart() {
        requestApplications(
                this.cloudFoundryClient,
                "test-application-name",
                TEST_SPACE_ID,
    ...
    void copySourceSpaceNotFound() {
        requestApplications(
                ...
                "test-metadata-id");
        requestSpace(this.cloudFoundryClient, TEST_SPACE_ID, TEST_ORGANIZATION_ID);
        requestOrganizationSpacesByNameNotFound(
                this.cloudFoundryClient, TEST_ORGANIZATION_ID, "test-target-space");
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Space test-target-space not found"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void deleteAndDeleteRoutes() {
        requestApplications(
                this.cloudFoundryClient, "test-name", TEST_SPACE_ID, "test-metadata-id");
    ...
    @Test
    void deleteAndDeleteRoutesFailure() {
        requestApplications(
                this.cloudFoundryClient, "test-name", TEST_SPACE_ID, "test-metadata-id");
        requestApplicationSummary(this.cloudFoundryClient, "test-metadata-id");
        requestDeleteRoute(this.cloudFoundryClient, "test-route-id");
    ...
    @Test
    void deleteAndDoNotDeleteRoutes() {
        requestApplications(
                this.cloudFoundryClient, "test-name", TEST_SPACE_ID, "test-metadata-id");
        requestApplicationSummary(this.cloudFoundryClient, "test-metadata-id");
        requestApplicationServiceBindingsEmpty(this.cloudFoundryClient, "test-metadata-id");
        ...
        this.applications
                .delete(DeleteApplicationRequest.builder().name("test-name").build())
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
    ...
    void deleteWithBoundRoutes() {
        ...
        requestRemoveServiceBinding(
                this.cloudFoundryClient, "test-metadata-id", "test-service-binding-id");
        requestDeleteApplication(this.cloudFoundryClient, "test-metadata-id");
        requestJobSuccess(this.cloudFoundryClient, "test-job-entity-id");
    ...
    void getApplicationManifest() {
        ...
        this.applications
                .getApplicationManifest(
                        GetApplicationManifestRequest.builder().name("test-app").build())
                .as(StepVerifier::create)
                .expectNext(
                        ApplicationManifest.builder()
                                ...
                                .healthCheckHttpEndpoint(
                                        "test-application-summary-healthCheckHttpEndpoint")
    ...
    @Test
    void getApplicationManifestDocker() {
        requestApplications(
                this.cloudFoundryClient, "test-app", TEST_SPACE_ID, "test-application-id");
    ...
    @Test
    void getApplicationManifestNoRoutes() {
        requestApplications(
                this.cloudFoundryClient, "test-app", TEST_SPACE_ID, "test-application-id");
    ...
    @Test
    void getApplicationManifestTcp() {
        requestApplications(
                this.cloudFoundryClient, "test-app", TEST_SPACE_ID, "test-application-id");
    ...
    void getEnvironments() {
        ...
        this.applications
                .getEnvironments(
                        GetApplicationEnvironmentsRequest.builder().name("test-app").build())
                .as(StepVerifier::create)
                .expectNext(
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Application test-app does not exist"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    void getEvents() {
        ...
        this.applications
                .getEvents(GetApplicationEventsRequest.builder().name("test-app").build())
                .as(StepVerifier::create)
                .expectNext(
    ...
    @Test
    void getWithEmptyInstanceStats() {
        requestApplications(
                this.cloudFoundryClient, "test-app", TEST_SPACE_ID, "test-application-id");
    ...
    void list() {
        ...
        this.applications
                ...
                .as(StepVerifier::create)
                .expectNext(
                        fill(ApplicationSummary.builder())
                                .id("test-application-summary-id")
                                .name("test-application-summary-name")
                                .requestedState("test-application-summary-state")
                                .build())
    ...
    void listTasks() {
        ...
        this.applications
                .listTasks(ListApplicationTasksRequest.builder().name("test-name").build())
                .as(StepVerifier::create)
                .expectNext(
                        fill(Task.builder())
    ...
    void pushDocker() {
        ...
        requestCreateDockerApplication(
                this.cloudFoundryClient,
                ...
                null,
                "test-application-id");
        requestPrivateDomainNotFound(
                this.cloudFoundryClient, "test-shared-domain", TEST_ORGANIZATION_ID);
        ...
        requestRoutesEmpty(
                this.cloudFoundryClient, "test-shared-domain-id", "test-name", null, null);
        requestCreateRoute(
                this.cloudFoundryClient,
    ...
    @Test
    void pushDockerPrivateRepository() {
        requestSpace(this.cloudFoundryClient, TEST_SPACE_ID, TEST_ORGANIZATION_ID);
        requestApplicationsEmpty(this.cloudFoundryClient, "test-name", TEST_SPACE_ID);
        requestCreateDockerApplication(
                this.cloudFoundryClient,
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Domain test-shared-domain not found"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void pushExistingApplication() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushExistingApplicationWithEnvironmentVariables() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        StepVerifier.withVirtualTime(
                        () ->
                                this.applications.pushManifest(
    ...
    @Test
    void pushExistingApplicationWithNullEnvironment() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushExistingRouteWithHost() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushExistingRouteWithNoHost() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushInvalidStack() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Stack invalid-stack does not exist"))
                .verify(Duration.ofSeconds(5));
    }
                                                ...
                                                .manifest(
                                                        ApplicationManifest.builder()
                                                                ...
                                                                .route(
                                                                        Route.builder()
                                                                                .route(
                                                                                        "test1.test-shared-domain")
                                                                                .build())
                                                                .route(
                                                                        Route.builder()
                                                                                .route(
                                                                                        "test2.test-shared-domain")
                                                                                .build())
                                                                .build())
                                                .build()))
                .then(() -> VirtualTimeScheduler.get().advanceTimeBy(Duration.ofSeconds(3)))
    ...
    @Test
    void pushNewApplication() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNewApplicationWithEnvironmentVariables() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        requestApplicationRoutes(this.cloudFoundryClient, "test-application-id", "test-route-id");
        requestRoutesEmpty(
                this.cloudFoundryClient, "test-shared-domain-id", "testname", null, null);
        requestCreateRoute(
                this.cloudFoundryClient,
                "test-shared-domain-id",
                "testname",
    ...
    @Test
    void pushNewRouteWithHost() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        requestApplicationRoutes(this.cloudFoundryClient, "test-application-id", "test-route-id");
        requestRoutesEmpty(
                this.cloudFoundryClient, "test-shared-domain-id", "test-host", null, null);
        requestListMatchingResources(
                this.cloudFoundryClient,
                Arrays.asList(
                        new ResourceMatchingUtils.ArtifactMetadata(
    ...
    @Test
    void pushNewRouteWithNoHost() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNoDomainNoneFound() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();

        requestApplicationsEmpty(this.cloudFoundryClient, "test-name", TEST_SPACE_ID);
        requestCreateApplication(
                this.cloudFoundryClient,
                ApplicationManifest.builder().path(testApplication).name("test-name").build(),
                TEST_SPACE_ID,
                null,
                "test-application-id");
        requestSpace(this.cloudFoundryClient, TEST_SPACE_ID, TEST_ORGANIZATION_ID);
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("No default domain found"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void pushNoDomainPrivate() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        requestPrivateDomains(
                this.cloudFoundryClient, TEST_ORGANIZATION_ID, "test-private-domain-id");
        requestSharedDomainsEmpty(this.cloudFoundryClient);
        requestListMatchingResources(
                this.cloudFoundryClient,
                Arrays.asList(
    ...
    @Test
    void pushNoDomainShared() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNoHostnameFlag() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNoInstances() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNoRouteFlag() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushNoStart() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    void pushPrivateDomain() throws IOException {
        ...
        requestSharedDomainsEmpty(this.cloudFoundryClient);
        requestRoutesEmpty(
                this.cloudFoundryClient, "test-private-domain-id", "test-name", null, null);
        requestApplicationRoutes(this.cloudFoundryClient, "test-application-id", "test-route-id");
        requestListMatchingResources(
                this.cloudFoundryClient,
                Arrays.asList(
    ...
    @Test
    void pushRandomRoute() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
        ...
        requestRoutesEmpty(
                this.cloudFoundryClient,
                "test-shared-domain-id",
                "test-applicationname-test-adjective-test-noun",
                null,
                null);
        requestListMatchingResources(
                this.cloudFoundryClient,
    ...
    @Test
    void pushSharedDomain() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushStartFailsRunning() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        ...
                                        .hasMessage("Application test-name failed during start"))
                .verify(Duration.ofSeconds(5));
    }

    @Test
    void pushStartFailsStaging() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushTcpRandomRoute() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void pushUploadFails() throws IOException {
        Path testApplication = new ClassPathResource("test-application.zip").getFile().toPath();
    ...
    @Test
    void restageInvalidApplication() {
        requestApplicationsEmpty(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);
    ...
    @Test
    void restageStartingFailurePartial() {
        requestApplications(
                this.cloudFoundryClient,
                "test-application-name",
                TEST_SPACE_ID,
    ...
    @Test
    void restageStartingFailureTotal() {
        requestApplications(
                this.cloudFoundryClient,
                "test-application-name",
                TEST_SPACE_ID,
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalStateException.class)
                                        .hasMessage(
                                                "Application test-app-name failed during start"))
                .verify(Duration.ofSeconds(5));
    }
    ...
    void restartInstance() {
        ...
        StepVerifier.withVirtualTime(
                        () ->
                                this.applications.restartInstance(
    ...
    @Test
    void scaleDiskAndInstancesNotStarted() {
        requestApplicationsSpecificState(
                this.cloudFoundryClient, "test-app-name", TEST_SPACE_ID, "STOPPED");
    ...
    @Test
    void scaleDiskAndInstancesStarted() {
        requestApplicationsSpecificState(
                this.cloudFoundryClient, "test-app-name", TEST_SPACE_ID, "STARTED");
        requestUpdateApplicationScale(
                this.cloudFoundryClient, "test-application-id", 2048, 2, null);
    ...
    void scaleInstances() {
        ...
        this.applications
                .scale(ScaleApplicationRequest.builder().name("test-app-name").instances(2).build())
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
    ...
    void scaleNoChange() {
        ...
        this.applications
                .scale(ScaleApplicationRequest.builder().name("test-app-name").build())
                .as(StepVerifier::create)
                .expectComplete()
                .verify(Duration.ofSeconds(5));
    }
    ...
    @Test
    void startApplicationFailureTotal() {
        requestApplicationsSpecificState(
                this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID, "STOPPED");
        requestUpdateApplicationState(this.cloudFoundryClient, "test-application-id", "STARTED");
        requestGetApplication(this.cloudFoundryClient, "test-application-id");
    ...
    @Test
    void startInvalidApplication() {
        requestApplicationsEmpty(this.cloudFoundryClient, "test-application-name", TEST_SPACE_ID);

        this.applications
                .start(StartApplicationRequest.builder().name("test-application-name").build())
                .as(StepVerifier::create)
                .consumeErrorWith(
                        t ->
                                assertThat(t)
        ...
        this.applications
                ...
                .consumeErrorWith(
                        t ->
                                assertThat(t)
                                        .isInstanceOf(IllegalArgumentException.class)
                                        .hasMessage("Task with sequence id of 1 does not exist"))
                .verify(Duration.ofSeconds(5));
    }
                ...
                .thenReturn(
                        Mono.just(
                                ApplicationInstancesResponse.builder()
                                        .instance(
                                                "instance-0",
                                                ApplicationInstanceInfo.builder().build())
                                        .build()));
    }
    ...
    private static void requestApplications(
        ...
        requestApplications(
                ...
                spaceId,
                applicationId,
                Collections.singletonMap("test-var", "test-value"));
    }
    ...
    private static void requestCancelTask(CloudFoundryClient cloudFoundryClient, String taskId) {
        when(cloudFoundryClient.tasks().cancel(CancelTaskRequest.builder().taskId(taskId).build()))
                .thenReturn(Mono.just(fill(CancelTaskResponse.builder()).build()));
    }

    private static void requestCopyBits(
            CloudFoundryClient cloudFoundryClient,
    ...
    private static void requestCreateApplication(
            CloudFoundryClient cloudFoundryClient,
        ...
        when(cloudFoundryClient.applicationsV2().create(builder.build()))
                .thenReturn(
                        Mono.just(
                                fill(CreateApplicationResponse.builder(), "create-")
                                        .metadata(
                                                fill(Metadata.builder()).id(applicationId).build())
                                        .build()));
    }

    private static void requestCreateDockerApplication(
            CloudFoundryClient cloudFoundryClient,
            PushApplicationRequest request,
            String spaceId,
            String stackId,
            String applicationId) {
        CreateApplicationRequest.Builder requestBuilder = CreateApplicationRequest.builder();
        requestBuilder.dockerCredentials(
                DockerCredentials.builder()
                ...
                .thenReturn(
                        Mono.just(
                                fill(CreateRouteResponse.builder())
                                        .metadata(fill(Metadata.builder()).id(routeId).build())
                                        .entity(fill(RouteEntity.builder()).build())
                                        .build()));
    }
                ...
                .thenReturn(
                        Mono.defer(
                                new Supplier<Mono<GetApplicationResponse>>() {
                                    ...
                                    private final Queue<GetApplicationResponse> responses =
                                            new LinkedList<>(
                                                    Arrays.asList(
                                                            fill(
                ...
                .thenReturn(
                        Mono.just(
                                fill(GetSharedDomainResponse.builder())
                                        .entity(SharedDomainEntity.builder().build())
                                        .build()));
    }
    ...
    private static void requestListMatchingResources(
            CloudFoundryClient cloudFoundryClient,
            Collection<ResourceMatchingUtils.ArtifactMetadata> artifactMetadatas) {
        ...
        when(cloudFoundryClient.resourceMatch().list(request))
    ...
    private static void requestSpace(
        ...
        when(cloudFoundryClient.spaces().get(GetSpaceRequest.builder().spaceId(spaceId).build()))
                .thenReturn(
                        Mono.just(
                                fill(GetSpaceResponse.builder())
                                        .entity(
                                                fill(SpaceEntity.builder())
                                                        .organizationId(organizationId)
                                                        .build())
                                        .build()));
    }
    ...
    private static void requestUpdateApplication(
            CloudFoundryClient cloudFoundryClient,
            String applicationId,
            ApplicationManifest manifest,
            String stackId) {
    ...
    private static void requestUpdateApplicationScale(
            CloudFoundryClient cloudFoundryClient,
            String applicationId,
            Integer disk,
            Integer instances,
                ...
                .thenReturn(
                        Mono.just(
                                fill(UploadApplicationResponse.builder())
                                        .metadata(fill(Metadata.builder()).id(jobId).build())
                                        .entity(fill(JobEntity.builder(), "job-entity-").build())
                                        .build()));
    }
}
